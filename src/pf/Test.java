...
public class Test {
	...
	ANTLRInputStream input = new ANTLRInputStream(new StringReader(
	    "select a(attr1)-b->c from asd as QQ <-qwe-C, b-W->RR where 1asd == 1asd or 1b == 1b"));
    ...
    private static Path parseOutboundPath(final Outbound_pathContext outboundPath) {
    ...
    private static Path parseInboundPath(final Inbound_pathContext inboundPath) {
    ...
    private static Path parsePath(final PathContext pathContext) {
